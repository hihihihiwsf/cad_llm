...
class SketchGraphsCollator:
    ...
    def __call__(self, sketch_dicts):
        ...
        input_strings = [sketch['input_text'] + self.tokenizer.sep_token for sketch in sketch_dicts]
        output_strings = [sketch['output_text'] for sketch in sketch_dicts]
        all_strings = [sketch['input_text'] + self.tokenizer.sep_token + sketch['output_text'] for sketch in sketch_dicts]

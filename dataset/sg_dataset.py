...
class sketchGraphRetrievalDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        sketch_dict['icl_text'] = sketch_dict['ice_prompt'].split('\n')[0].replace('\t','')
        assert len(sketch_dict['icl_text'])>0
...
class SketchGraphsRetrievalCollator:
    ...
    def __call__(self, sketch_dicts):
        ...
        # try:
        #     assert et-st<150
        #     print("colloator time:", et-st)
        # except:
        #     print("sketch['input_text]:", point_inputs)
        #     embed()
        ...
        batch = {
            ...
            "icl_image": icl_batch_images.pixel_values,
            "output_image": output_images.pixel_values,
        }
        return batch 

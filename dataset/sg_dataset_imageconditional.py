...
class SketchGraphsCollator:
    ...
    def __call__(self, sketch_dicts):
        input_strings = [sketch['input_text']+sketch['output_text'] for sketch in sketch_dicts]
        output_strings = [sketch['input_text']+sketch['output_text'] for sketch in sketch_dicts]

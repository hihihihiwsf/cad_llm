...
def convert_obj_data_to_strings(obj_data, offset):
    ...
    for sketch in obj_data:
        ...
        string_sketch = preprocess_sketch(sketch, quantize_bits=6, new_tokens=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=str, default="./data/deepmind_obj", help="Input folder containing obj-like json files")

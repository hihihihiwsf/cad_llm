...
def deduplicate_splits(split_to_sketches):
    ...
    print(f"Deduplicate whole dataset - removed {before_count - after_count} sketches ({before_count} to {after_count})")
    ...
    split_to_sketches={"total":deduped_sketches}

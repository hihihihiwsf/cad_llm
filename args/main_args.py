...
def get_parser():
    ...
    parser.add_argument("--num_workers", type=int, default=32, help="Number of workers to use in the torch dataloader")
    ...
    parser.add_argument("--architecture", type=str, default="byt5_v2", choices=("vl_byt5_v2", "bi_vl_byt5_v2", "vl_byt5", "byt5_v2"))

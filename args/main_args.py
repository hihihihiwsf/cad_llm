...
def get_parser():
    ...
    parser.add_argument("--dataset", type=str, default="/home/ec2-user/data/deepmind_strings_v1_ascii1_max64", help="Dataset path") #/home/ec2-user/data/sg_string_v5_ascii_max64
    ...
    parser.add_argument("--model_name", type=str, default="Google/byt5-small", help="Huggingface model name") #Salesforce/codet5p-220m  #Google/byt5-small

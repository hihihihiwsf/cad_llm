...
def get_parser():
    ...
    parser.add_argument("--dataset", type=str, default="/home/ec2-user/data/sifan_test_ascii", help="Dataset path")
    ...
    parser.add_argument("--model_name", type=str, default="Salesforce/blip2-flan-t5-xl" , help="Huggingface model name") #"Salesforce/blip2-flan-t5-xl"  #"Salesforce/blip-image-captioning-base", Salesforce/blip2-opt-2.7b

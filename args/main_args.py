...
def get_parser():
    ...
    parser.add_argument("--model_name", type=str, default="Salesforce/blip2" , help="Huggingface model name") #"Salesforce/blip2-flan-t5-xl"  #"Salesforce/blip-image-captioning-base"

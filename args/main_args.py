...
def get_parser():
    ...
    parser.add_argument("--results_dir", type=str, default="/Tmp/sifan/cad/results", help="Directory to save checkpoints and logs")
    parser.add_argument("--dataset", type=str, default="/Tmp/sifan/cad/data/sg_strings_v7_with_constraints", help="Dataset path") #sg_string_v5_ascii_max64  #sg_strings_v7_with_constraints
    ...
    parser.add_argument("--adafactor", type=int, default=0, help="Apply adafactor Learning rate decay if true")
    ...
    parser.add_argument("--arch", default="vlt5_v2_tri")

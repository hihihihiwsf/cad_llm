...
class BLIPModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        cols = ["input_ids", "pixel_values", "attention_mask", "labels"]
    ...
    def generate_samples(self, batch):
        ...
        batch["samples"] = generate_func(input_ids=batch["input_ids"], attention_mask=batch["attention_mask"], pixel_values=batch['pixel_values'],

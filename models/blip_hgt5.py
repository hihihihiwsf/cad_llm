...
from transformers import BertTokenizer, AutoTokenizer, T5ForConditionalGeneration
...
class BLIP_Pretrain(nn.Module):
    def __init__(self,          
        ...
        # self.text_encoder_m = T5ForConditionalGeneration(config=self.model.config, add_pooling_layer=False)      
    ...
    def generate(self, images, input_ids, attention_mask, sample=False, num_beams=3, max_length=100, min_length=96, top_p=0.9, repetition_penalty=1.0):
